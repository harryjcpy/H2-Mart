...
const slides = [
  {
    ...
    quote:
      "Unleash Your Passion for E-Commerce and Embrace the Thrill of the Game",
    saleText:
      "Get in the game with up to 50% off on a wide range of E-Commerce products",
    productText: "Shop Now",
  },
  {
    image: require("../../Image/Cricket-wepon/03.jpg"),
    quote:
      "Experience the Unparalleled Excitement and Achieve Victory with Our Premium E-Commerce Equipment",
    saleText:
