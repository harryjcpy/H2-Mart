 ...
 const footSocial = [
   {
     ...
     path: "https://www.facebook.com/harshit.shukla.71619533",
   },
   {
     id: 2,
     icon: <GitHubIcon className="twitter_icon" fontSize="large" />,
     path: "https://github.com/Shukla12345677",
   },
   {
     id: 3,
     icon: <InstagramIcon className="insta_icon" fontSize="large" />,
     path: "https://www.instagram.com/harshitshukla616/",
   },
   {
     id: 4,
     icon: <LinkedInIcon className="likedin_icon" fontSize="large" />,
     path: "linkedin.com/in/harshit-shukla-4a6734209",
   },
 ];
              ...
              <div className="foot_logo" >
                <Link to="/" style={{ textDecoration: "none"  }}>
                  {/* <img
                    ...
                    style={{width : "80px" , marginLeft : "-50px" , paddingTop : "10px"}}
                  /> */}
                  <h1 className="Foot_heading">H2 Mart</h1>
                </Link>
              </div>
          ...
          <div className="container_Footer">
            <div className="sub_footer_wrapper">
              ...
              <div className="foot_copyright">
                <p>
                  &copy; {currYear} | H2 Mart, All Rights Reserved.
                  <span>
                    <a href="#"> | Built by Harshit Shukla && Harshit Mishra</a>
                  </span>
                </p>
              </div>
            </div>
