    ...
    <Box className={classes.root_contactus}>
      ...
      <div className={classes.contact_Container_contactus}>
        ...
        <Typography variant="body2" className={classes.para_contact}>
          We have email chat bot available, Send  your concern through message box 
          and MailChatBot resolve your issue with in 24hr. If it isn’t work for you, then give us a call at{" "}
          <strong
            style={{
        ...
        <Typography variant="body2" className={classes.para_contact}>
          ...
          <br />
          <span className={classes.para2}>Live call Closed Sunday </span>
        </Typography>

        <Typography variant="body2" className={classes.para_contact}>
          Catch us outside these hours? Fill out our   MailChatBot  form below, and
        MailChatBot will be in touch shortly.
        </Typography>
