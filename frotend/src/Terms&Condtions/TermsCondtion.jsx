  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with H² Mart! We appreciate your business
          and your interest in our e-commerce equipment. We want to make sure you
        ...
        <p>
          You (“Customer”) may place orders for Products with H² Mart
          ...
          agreed to in writing by H² Mart.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to H² Mart's acceptance. We may refuse to
        ...
        <p>
          ...
          H² Mart.Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock H² Mart products. We
        ...
        <p>
          ...
          taxes, except for those based on H² Mart's income. If
          H² Mart is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without H² Mart's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold H² Mart harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between H² Mart and
