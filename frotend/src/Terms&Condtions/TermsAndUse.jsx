    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, HSquare.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with  HSquare
          ...
          agreed to or set forth in writing by  HSquare, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to  HSquare's acceptance. This means
          H² Mart may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged,  HSquare
        ...
        <p>
          ...
          and it is accepted by  HSquare. Prices for products displayed on
          ...
          website may differ from those in stores that stock  HSquare
          products, as these stores are independent of  HSquare.
          HSquare reserves the right to amend pricing for any pricing
          ...
          submitted an online order, HSquare will notify you of the error
        ...
        <p>
          ...
          H² Mart reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse H² Mart if it pays, any
          taxes, except for those based on H² Mart's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by H² Mart for when the
          ...
          are beyond our control. H² Mart cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by H² Mart, customer
          may not cancel such accepted order without H² Mart’s prior
          ...
          expenses. The product(s) must be returned to H² Mart within
        ...
        <p>
          ...
          indemnify and hold H² Mart harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>H² Mart</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@H²Mart.com</span>
        </p>
      </div>
    </div>
  );
